...
set GRPC_PATH=C:\FacultateSem2\vcpkg-master\installed\x86-windows\tools\grpc
set PROTOC_PATH=C:\FacultateSem2\vcpkg-master\installed\x86-windows\tools\protobuf
